...
class ArchivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create archive" do
    assert_difference("Archive.count") do
      post archives_url, params: { archive: { description: @archive.description, title: @archive.title } }
    end
  ...
  test "should update archive" do
    patch archive_url(@archive), params: { archive: { description: @archive.description, title: @archive.title } }
